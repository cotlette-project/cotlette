...
from fastapi_admin.utils.autoreload import autoreload_started, file_changed
from fastapi_admin.utils.functional import lazy
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from fastapi_admin.utils.translation import trans_real as trans
            from fastapi_admin.utils.translation.reloader import (
            ...
            from fastapi_admin.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from fastapi_admin.conf.locale import LANG_INFO

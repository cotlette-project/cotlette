...
from fastapi_admin.core import checks
from fastapi_admin.core.exceptions import ImproperlyConfigured
from fastapi_admin.core.management.color import color_style, no_style
from fastapi_admin.db import DEFAULT_DB_ALIAS, connections
...
class BaseCommand:
    ...
    def get_version(self):
        ...
        """
        # return fastapi_admin.get_version()
        return "0.0.1"

...
from fastapi_admin.conf import settings
from fastapi_admin.core.management.base import BaseCommand, CommandError
from fastapi_admin.core.management.utils import (
    find_formatters,
    handle_extensions,
    run_formatters,
)
from fastapi_admin.template import Context, Engine
from fastapi_admin.utils import archive
from fastapi_admin.utils.http import parse_header_parameters
from fastapi_admin.utils.version import get_docs_version
...
class TemplateCommand(BaseCommand):
        ...
        context = Context(
            {
                **options,
                ...
                "django_version": fastapi_admin.__version__,
            },
            autoescape=False,
        )
    ...
    def handle_template(self, template, subdir):
        ...
        """
        if template is None:
            return os.path.join(fastapi_admin.__path__[0], "conf", subdir)
        else:

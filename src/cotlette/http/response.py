...
from cotlette.core import signals, signing
from cotlette.core.exceptions import DisallowedRedirect
from cotlette.core.serializers.json import DjangoJSONEncoder
from cotlette.http.cookie import SimpleCookie
from cotlette.utils import timezone
from cotlette.utils.datastructures import CaseInsensitiveMapping
from cotlette.utils.encoding import iri_to_uri
from cotlette.utils.functional import cached_property
from cotlette.utils.http import content_disposition_header, http_date
...
class JsonResponse(HttpResponse):
    ...
    :param encoder: Should be a json encoder class. Defaults to
      ``cotlette.core.serializers.json.DjangoJSONEncoder``.

...
SECRET_KEY_INSECURE_PREFIX = "cotlette-insecure-"
...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by Cotlette. Please generate a long and random value, "
    f"otherwise many of Cotlette's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'cotlette.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'cotlette.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "cotlette.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "cotlette.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )

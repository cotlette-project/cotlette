...
from cotlette.core.cache.backends.base import DEFAULT_TIMEOUT, BaseCache
from cotlette.db import DatabaseError, connections, models, router, transaction
from cotlette.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a Cotlette model _meta class.

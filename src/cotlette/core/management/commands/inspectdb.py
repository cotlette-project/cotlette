...
class Command(BaseCommand):
    help = (
        "Introspects the database tables in the given database and outputs a Cotlette "
        "model module."
    )
    requires_system_checks = []
    stealth_options = ("table_name_filter",)
    db_module = "cotlette.db"
    ...
    def handle_inspection(self, options):
        ...
        with connection.cursor() as cursor:
            yield "# This is an auto-generated Cotlette model module."
            ...
            yield (
                ...
                "Cotlette to create, modify, and delete the table"
            )
            yield (

...
class Command(BaseCommand):
    help = """Displays differences between the current settings.py and Cotlette's
    default settings."""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "empty to compare against Cotlette's default settings."
            ),
        )
        parser.add_argument(
            "--output",
    ...
    def handle(self, **options):
        from cotlette.conf import Settings, global_settings, settings

# This file is distributed under the same license as the Cotlette package.
#
# The *_FORMAT strings use the Cotlette date format syntax,
# see https://docs.cotletteproject.com/en/dev/ref/templates/builtins/#date
